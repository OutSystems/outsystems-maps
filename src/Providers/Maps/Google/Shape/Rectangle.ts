...
namespace Provider.Maps.Google.Shape {
	export class Rectangle
		extends AbstractProviderShape<Configuration.Shape.RectangleShapeConfig, google.maps.Rectangle>
		implements OSFramework.Maps.Shape.IShapeRectangle
	{
		...
		protected _createProvider(bounds: OSFramework.Maps.OSStructures.OSMap.Bounds): google.maps.Rectangle {

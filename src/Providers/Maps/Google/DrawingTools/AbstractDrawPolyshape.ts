...
namespace Provider.Maps.Google.DrawingTools {
	export abstract class AbstractDrawPolyshape<
		W extends Configuration.DrawingTools.DrawBasicShapeConfig | Configuration.DrawingTools.DrawFilledShapeConfig,
	> extends AbstractDrawShape<W> {
		...
		protected createConfigsElement(
			...
			configs: Configuration.Shape.BasicShapeConfig | Configuration.Shape.FilledShapeConfig
		): Configuration.Shape.BasicShapeConfig | Configuration.Shape.FilledShapeConfig {
			...
			return finalConfigs as Configuration.Shape.BasicShapeConfig | Configuration.Shape.FilledShapeConfig;
		}

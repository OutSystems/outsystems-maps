...
namespace Provider.Maps.Leaflet.Constants.Directions.OSRM {
	/**
...
// eslint-disable-next-line @typescript-eslint/no-unused-vars
namespace Provider.Maps.Leaflet.Constants.Directions.MapBox {
	/**
...
// eslint-disable-next-line @typescript-eslint/no-unused-vars
namespace Provider.Maps.Leaflet.Constants.Directions.GraphHopper {
	/**
...
// eslint-disable-next-line @typescript-eslint/no-unused-vars
namespace Provider.Maps.Leaflet.Constants.Directions.TomTom {
	/**

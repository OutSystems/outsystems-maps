...
namespace Provider.Maps.Leaflet.Feature {
	export class Offset implements OSFramework.Maps.Feature.IOffset, OSFramework.Maps.Interface.IBuilder {
		private _map: OSMap.IMapLeaflet;
		/** Current offset of the Map */
		private _offset: OSFramework.Maps.OSStructures.OSMap.Offset;

		constructor(map: OSMap.IMapLeaflet, offset: OSFramework.Maps.OSStructures.OSMap.Offset) {
			this._map = map;

...
namespace Provider.DrawingTools.TerraDraw {
	export class DrawMarker extends AbstractProviderTool<Provider.Maps.Google.Configuration.DrawingTools.DrawMarkerConfig> {
		constructor(
			...
			super(
				...
				drawingToolsId,
				type,
				new Provider.Maps.Google.Configuration.DrawingTools.DrawMarkerConfig(configs)
			);
		}
		...
		protected createElement(
			...
			configs: Provider.Maps.Google.Configuration.DrawingTools.DrawMarkerConfig
		...
		public get options(): Provider.Maps.Google.Configuration.DrawingTools.DrawMarkerConfig {
			return this.config;
		}

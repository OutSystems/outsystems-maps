...
namespace Provider.DrawingTools.TerraDraw {
	export class DrawPolyline extends AbstractDrawPolyshape<Configuration.DrawBasicShapeConfig> {
		constructor(
			...
			super(
				...
				drawingToolsId,
				type,
				new Configuration.DrawBasicShapeConfig(configs)
			);
		}
		...
		protected createElement(
			...
			configs: Configuration.DrawBasicShapeConfig
		...
		public get options(): Configuration.DrawBasicShapeConfig {
			return this.config;
		}

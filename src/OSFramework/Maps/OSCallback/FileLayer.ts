...
namespace OSFramework.Callbacks.FileLayer {
    /**
     ...
     * @param {OSFramework.FileLayer.FileLayer} fileLayerObj object of the FileLayer that triggered the event
     */
    export type Event = {
        (
            mapId: string,
            fileLayerId: string,
            fileLayerObj: OSFramework.FileLayer.IFileLayer,

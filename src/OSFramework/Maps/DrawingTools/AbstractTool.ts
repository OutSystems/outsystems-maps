...
namespace OSFramework.Maps.DrawingTools {
	export abstract class AbstractTool<T extends Configuration.IConfigurationTool> implements ITool {
		...
		constructor(map: OSMap.IMap, drawingTools: IDrawingTools, uniqueId: string, type: string, config: T) {
			this._map = map;

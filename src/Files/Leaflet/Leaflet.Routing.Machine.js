					...
					return {
						...
						compile: function (language, step, opts) {
							...
							switch (type) {
								case 'use lane':
									laneInstruction =
										instructions[language][version].constants.lanes[this.laneConfig(step)];
									if (!laneInstruction) {
						...
						module.exports = L.Class.extend({
							...
							initialize: function (elem, callback, context, options) {
								...
								this._autocomplete = options.autocompleteFn
									? L.Util.bind(options.autocompleteFn, options.autocompleteContext)
									: null;
					...
					(function () {
						...
						module.exports = Itinerary.extend({
							...
							_onZoomEnd: function () {
								...
								var map = this._map;
								if (
									this._router.requiresMoreDetail(this._selectedRoute, map.getZoom(), map.getBounds())
								) {
									this.route({
							...
							_updateLines: function (routes) {
								var addWaypoints =
									this.options.addWaypoints !== undefined ? this.options.addWaypoints : true;
								this._clearLines();
						...
						module.exports = L.Control.extend({
							...
							_createAlternative: function (alt, i) {
								var altDiv = L.DomUtil.create(
										...
										'leaflet-routing-alt ' +
											...
											(i > 0
												? ' leaflet-routing-alt-minimized ' + this.options.minimizedClassName
												: '')
									),
								...
								altDiv.innerHTML =
									typeof template === 'function' ? template(data) : L.Util.template(template, data);
							...
							_addRowListeners: function (row, coordinate) {
								L.DomEvent.addListener(
									...
									'mouseover',
									function () {
										this._marker = L.circleMarker(coordinate, this.options.pointMarkerStyle).addTo(
											this._map
										);
									},
									this
						...
						module.exports = L.Class.extend({
							...
							_convertRoute: function (responseRoute) {
								...
								for (i = 0; i < legCount; i++) {
									...
									legNames.push(
										leg.summary && leg.summary.charAt(0).toUpperCase() + leg.summary.substring(1)
									);
